    ...
    run: async function (client, message, args) {
        ...
        if (serverQueue) {
            ...
            let thing = new MessageEmbed()
                .setAuthor("Song Has Been Added To The Queue!", "https://cdn.discordapp.com/emojis/809425166014480394.gif?v=1")
        ...
        const play = async (song) => {
            ...
            let thing = new MessageEmbed()
                .setAuthor("Music Has Started!", "https://cdn.discordapp.com/emojis/791034054434357263.gif?v=1")
                .setThumbnail(song.img)
                .setColor("BLACK")
                .addField("Name", song.title, true)
                .addField("Duration", song.duration, true)
