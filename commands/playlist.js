...
module.exports = {
    info: {
        name: "playlist",
        description: "Plays youtube playlists.",
    ...
    run: async function (client, message, args) {
        ...
        if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
            ...
            try {
                ...
                let thing = new MessageEmbed()
                    .setAuthor("Playlist Has Been Added To The Queue!", "https://cdn.discordapp.com/emojis/791034054434357263.gif?v=1")
        ...
        async function play(guild, song) {
            ...
            if (!song) {
                sendError(
                    "Leaving the VC because the queue has ended.",
                    message.channel
                );
            ...
            let thing = new MessageEmbed()
                .setAuthor("Started Playing Music!", "https://cdn.discordapp.com/emojis/791034054434357263.gif?v=1")
                .setThumbnail(song.img)
                .setColor("BLACK")
                .addField("Name", song.title, true)
                .addField("Duration", song.duration, true)
