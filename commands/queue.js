...
module.exports = {
  info: {
    name: "queue",
    description: "Displays the servers current music queue.",
    usage: "",
...
function generateQueueEmbed(message, queue) {
  ...
  for (let i = 0; i < queue.length; i += 10) {
    ...
    const embed = new MessageEmbed()
     .setAuthor("Server Queue", "https://cdn.discordapp.com/emojis/791034054434357263.gif?v=1")
    ...
    .setFooter("The Current Server Volume Is "+serverQueue.volume)
